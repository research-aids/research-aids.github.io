...
Relevant data:
  ...
  Tags:
    Activity:
      - "[Society](http://vocab.getty.edu/aat/300026009)"
...
Sources:
  Primary sources:
    - Type of source: "Publication"
      ...
      Description and remarks: "The journal published by the Bataviaasch Genootschap from 1779. Many editions can be found on the Biodiversity Heritage Library website."
    - Type of source: "Minutes"
      ...
      Description and remarks: "Minutes of meetings of the Bataviaasch Genootschap published from the 1850s onwards. Minutes from 1864 to 1922 are available through Leiden University Library."
    - Type of source: "Archive"
      ...
      Description and remarks: "The archive of the Bataviaasch Genootschap is located at the ANRI in Jakarta. The inventory of the archive can be downloaded from the ANRI's website (in Indonesian)."
    - Type of source: "Journal"
      ...
      Description and remarks: "Journal published by the Bataviaasch Genootschap. Several editions are available through the Royal Netherlands Institute of Southeast Asian and Caribbean Studies (KITLV). Other sources related to the Bataviaasch Genootschap can also be found on this web page."
  Secondary sources:
    - Type of source: "Book"
      Name: "Groot, Hans. Van Batavia naar Weltevreden: Het Bataviaasch Genootschap van Kunsten en Wetenschappen, 1778-1867. Amsterdam: Brill, 2009"
      Link:
        - URL: "http://library.oapen.org/handle/20.500.12657/34657"
      Description and remarks: "Book by Hans Groot with a comprehensive description of the Bataviaasch Genootschap from its foundation to 1867. Also contains a large amount of information on collections acquired and specific members of the Society."
