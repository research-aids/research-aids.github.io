...
Relevant data:
  Tags:
    ...
    Geographical:
      ...
      - "[Saint Martin](https://sws.geonames.org/7609695/)"
...
Sources:
  ...
  Secondary sources:
    ...
    - Type of source: "Book"
      ...
      Description and remarks: "Book published in 2023 as part of the project 'Ons koloniale verleden in 50 voorwerpen', which also features various objects from the SSS islands."
