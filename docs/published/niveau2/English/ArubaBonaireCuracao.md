...
[Download PDF](https://raw.githubusercontent.com/colonial-heritage/research-aids/refs/heads/main/EXPORTS/PDF/published/niveau2/English/ArubaBonaireCuracao){: .btn .btn-blue }			[Download DOCX](https://raw.githubusercontent.com/colonial-heritage/research-aids/refs/heads/main/EXPORTS/DOCX/published/niveau2/English/ArubaBonaireCuracao){: .btn .btn-blue }

Level: 2

Title: "Aruba, Bonaire and Curaçao"

Abstract: "Dutch museums contain many objects originating from Aruba, Bonaire and Curaçao when the islands were under Dutch colonial rule. Objects from Aruba, Bonaire and Curaçao held in Dutch museum collections are often not attributed to specific islands. It is therefore important to use multiple search terms referring to the islands in the Caribbean region formerly colonised by the Netherlands."
...
Sources:
  ...
  Secondary sources:
    - Type of source: "Book"
      Name: "Heijer, H. J. den. Geschiedenis van de WIC: opkomst, bloei en ondergang. Vierde herziende druk. Walburg Pers, 2013."
      Link:
        - URL: "https://search.worldcat.org/title/861797634"
      Description and remarks: "Book published in 2013 about the history of the Dutch West India Company (WIC), which played an active role in the colonisation of the Caribbean."
    - Type of source: "Book"
      Name: "Oostindie, Gert. Paradise Overseas: The Dutch Caribbean, Colonialism and its Transatlantic Legacies. Warwick University Caribbean Studies. Macmillan Caribbean, 2005."
      Link:
        - URL: "https://search.worldcat.org/title/61483105"
      Description and remarks: "Book published in 2005 that describes the history of the colonisation of the ABC islands by the Netherlands in seven essays."
    - Type of source: "Book"
      Name: "Oostindie, Gert, and Roitman, Jessica V. (eds). Dutch Atlantic Connections, 1680-1800. Brill, 2014."
      Link: 
        - URL: "https://brill.com/edcollbook-oa/title/25367"
      Description and remarks: "Book published in 2014 that examines the role of the Netherlands in the colonisation of the Atlantic world."
    - Type of source: "Book"
      Name: "Martis, A. De geschiedenis van Aruba tot 1816: van zustereiland tot imperium in imperio. LM Publishers, 2018."
      Link: 
        - URL: "https://search.worldcat.org/title/1051752557?oclcNum=1051752557"
      Description and remarks: "Book published in 2018 covering the history of the island of Aruba up to 1816. It describes the pre-colonial period (2500 BC-1500), the years when the island was under Spanish rule (1499-1634), the period under the administration of the Dutch West India Company (1636-1791) and the transitional years that followed until the transfer of the island from the British to the Dutch (1792-1816)."
    - Type of source: "Book"
      Name: "Alofs, Luc. Koloniale mythen en Benedenwindse feiten: Curaçao, Aruba en Bonaire in inheems Atlantisch perspectief, ca. 1499-1636. Sidestone Press, 2018."
      Link: 
        - URL: "https://search.worldcat.org/title/1050133765"
      Description and remarks: "Book published in 2018 describing the period of Spanish rule on the ABC islands."
    - Type of source: "Book"
      Name: "Smeulders, Valika (ed). Ons koloniale verleden: in 50 voorwerpen. Alfabet Uitgevers, 2023."
      Link: 
        - URL: "https://search.worldcat.org/title/1452966194"
      Description and remarks: "Book published in 2023 as part of the project Our colonial past in 50 objects, which also features various objects from the ABC islands."
    - Type of source: "Book"
      Name: "Stipriaan, Alex van, Alofs, Luc and Guadeloupe, Francio (eds). Caribbean cultural heritage and the nation: Aruba, Bonaire and Curaçao in a regional context. Leiden University Press, 2023."
      Link:
        - URL: "https://www.jstor.org/stable/10.2307/jj.4470335"
      Description and remarks: "Book about the history of shared cultural heritage of the ABC islands."
...
editing_metadata:
  - date: 2024-11-25
    ...
    editing_notes: metadata added on 2025-06-19. from now, mayor changes to the file need to be logged here. 
  - date: 2025-03-04
    applies_to: Content
    author: Wiebe Reints
    role: original_author
    editing_notes: Processed remarks by Dyonna Bennet (expert on Caribbean heritage) 
  - date: 2025-06-19
    applies_to: Content
    author: Maarten van der Bent 
    role: editor
    editing_notes: Original research aid has been separated into two, ABC islands and SSS islands.
  - date: 2025-10-20
    applies_to: 
    author: Abacus
    role: translator
