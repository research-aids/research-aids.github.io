...
Relevant data:
  ...
  Tags:
    ...
    Geographical:
      ...
      - "[New Guinea](https://sws.geonames.org/2082514/)"
...
Sources:
  Primary sources:
    - Type of source: "Archive"
      ...
      Description and remarks: "Archive of the Nederlands Volkenkundig Missiemuseum (Netherlands Ethnographic Missionary Museum) at the Tilburg Regional Archives. Box 20 contains, among other things, an inventory of the museum collection."
  Secondary sources:
    - Type of source: "Article"
      ...
      Description and remarks: "Article by Cees van Raak (in Dutch) on the history of the Nederlands Volkenkundig Missiemuseum in Tilburg. The article describes in detail the history of the museum, the various parts of the collection and the curators over the years."
    - Type of source: "Book"
      ...
      Link: 
        ...
        - OCLC: "781496494"
        - ISBN: "9789024644247"
      Description and remarks: Booklet from 1982 with descriptions of various museums. The chapter 'Van vreemde volken' (Of foreign peoples) briefly discusses the Nederlands Volkenkundig Missiemuseum in Tilburg.
